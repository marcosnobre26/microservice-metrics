...
class MetricsClassesSeeder extends Seeder
{
    /**
    ...
    public function Classes(){//popular a tabela de metrics courses
        $list = Courses::with('modules.classes')->get();
                ...
                foreach($course->modules as $module){
                    foreach($module->classes as $class){
                        foreach($search as $register){
                            ...
                            $time_plus = "00:00:00";
                            $time = "00:00:00";
                            $time_total = $this->classTimeTotal($class->id);
                            $time_consumed = $this->classTimeConsumed($class->id);
                            $percent_finished = 0;
    ...
    public function classTimeTotal($id){
    ...
    public function classTimeConsumed($id){
        $class = Classes::where('id', $id)->first();
        $hora_um = "00:00:00";
