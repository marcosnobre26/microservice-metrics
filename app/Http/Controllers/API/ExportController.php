...
namespace TheMembers\Http\Controllers\Api;
...
{
    public function exportCourse($id) //$id de Curso
    {
        return Excel::download(new MetricCoursesExport($id, Auth::user()->tenant_id), 'users.xlsx');
    }
}
